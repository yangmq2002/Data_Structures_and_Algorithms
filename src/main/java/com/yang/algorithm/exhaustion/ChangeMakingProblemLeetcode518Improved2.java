package com.yang.algorithm.exhaustion;
 ...
 */
public class ChangeMakingProblemLeetcode518Improved2 {
    static int level = -2;
    ...
    public static void main(String[] args) {
        ChangeMakingProblemLeetcode518Improved2 leetcode = new ChangeMakingProblemLeetcode518Improved2();
